/// 
/// @file builderSolutionSelection.h
/// @author Jxtopher
/// @brief 
/// @version 0.1
/// @date 2019-08-28
...
class solutionSelectionBuilder {
    public:
       static std::unique_ptr<SolutionSelection<SOL>> build(const Problem<SOL, TYPE_FITNESS, TYPE_CELL> & problem, const Json::Value &configuration) {
            ...
            if (configuration.asString() == SolutionSelection<SOL>::MAXIMIZATION) {
                ...
                throw std::runtime_error(std::string{} + __FILE__ + ":" + std::to_string(__LINE__) + " The SolutionSelection does not exist.");
            }
