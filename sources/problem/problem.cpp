...
void Problem<SOL, TYPE_FITNESS, TYPE_CELL>::evaluationIncremental(
    const SOL& s, const std::vector<std::pair<unsigned int, TYPE_CELL>>& _listOfMutations) const {
    throw std::runtime_error(std::string{} + __FILE__ + ":" + std::to_string(__LINE__) +
...
template<typename SOL, typename TYPE_FITNESS, typename TYPE_CELL>
TYPE_FITNESS
    Problem<SOL, TYPE_FITNESS, TYPE_CELL>::getFitnessObjectif(unsigned int numObjectif) const {
    throw std::runtime_error(std::string{} + __FILE__ + ":" + std::to_string(__LINE__) +
...
///-------------
template<typename SOL, typename TYPE_FITNESS, typename TYPE_CELL>
bool Problem<SOL, TYPE_FITNESS, TYPE_CELL>::solutionSelection(const SOL& s_worst,
                                                              const SOL& s_best) {
    throw std::runtime_error(std::string{} + __FILE__ + ":" + std::to_string(__LINE__) +
