...
class SolutionArray : public Solution<TYPE_FITNESS> {
   public:
    ...
    // Deserialization
    SolutionArray(const unsigned char *deserialization) : Solution<TYPE_FITNESS>(deserialization) {
        ...
        memcpy(static_cast<void *>(&sizeSolutionArray), static_cast<const void *>(cursorData),
    ...
    [[deprecated("Please do not user serialization. Prefere Json")]] SolutionArray(const string &solution)
        ...
        while (std::getline(ssFitness, token, ' ')) {
            ...
            if (this->_fitness == nullptr) {
                ...
                // this->_fitness = static_cast<TYPE_FITNESS *>(realloc (this->_fitness, this->_numberOfObjective *
                // sizeof(TYPE_FITNESS)));
                ...
                // this->_fitnessIsValid = static_cast<bool *>(realloc (this->_fitnessIsValid, this->_numberOfObjective
                // * sizeof(bool)));
    ...
    // Serialization
    [[deprecated("Please do not user serialization. Prefere Json")]] unsigned char *serialization() {
        ...
        unsigned long long sizeSolutionArray =
            sizeof(unsigned long long) + sizeof(unsigned int) + sizeof(TYPE_CELL) * _sizeArray;
    ...
    void
    operator()(const unsigned int index, const TYPE_CELL value) {
