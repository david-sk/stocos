...
template class SensorFinal<Fitness<int>>;
template class SensorFinal<Solution<double, double>>;
template class SensorFinal<Solution<double, bool>>;
template class SensorFinal<Solution<int, bool>>;
template class SensorFinal<Solution<unsigned int, bool>>;
template class SensorFinal<Solution<double, unsigned int>>;
template class SensorFinal<Solution<unsigned int, unsigned int>>;
