...
template class Statistic<Fitness<int>>;
template class Statistic<Solution<double, double>>;
template class Statistic<Solution<double, bool>>;
template class Statistic<Solution<int, bool>>;
template class Statistic<Solution<unsigned int, bool>>;
template class Statistic<Solution<double, unsigned int>>;
template class Statistic<Solution<unsigned int, unsigned int>>;
